...
- 2025秋无任何考勤。
- 共 1 次作业，是简单的星等和距离的计算，只要交了平时分就能拿满
- 老师组织了两次实地观测，一次是观测星空，一次是观测太阳，自愿参加，不过很推荐去，很有意思
...
25 秋期末考试闭卷，可以使用计算器，题型为 10 题填空 + 5 题简答 + 2 题计算，简答题是课上重点讲过的行星磁场，恒星演化等，计算题是星等和距离计算，与作业强相关。总体难度不大。
